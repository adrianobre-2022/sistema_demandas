...
with aba_formulario:
    # Uso de contêiner isolado para garantir que nada saia desta aba
    with st.container():
...
# --- ABA 2: PAINEL DO COMERCIANTE / GESTOR (EXCLUSIVO PARA CONSULTA) ---
with aba_painel:
    # Contêiner isolado exclusivo do painel de controle
    with st.container():
