...
# --- TELA: PAINEL DE DECISÃO ESTRATÉGICA (B2B) ---
    ...
    if st.session_state.perfil_cliente == "admin":
        ...
        try:
            ...
            if resposta.data and len(resposta.data) > 0:
                for registro in resposta.data:
                    if registro.get("locais_destino"):
                        ...
                        # FILTRAGEM INTELIGENTE RELAXADA: Impede o apagão por diferença de strings maiúsculas ou acentos
            ...
            # UNIÃO DE FORÇAS: Se o banco tiver dados, mas forem poucos, anexa os mocks de segurança para teste de estresse
            dados_mock = [
