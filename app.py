            ...
            if not df.empty:
                ...
                if not df_filtrado.empty:
                    ...
                    if espectador_analitico:
                        ...
                        st.markdown(
                            f"<div style='text-align: right; font-size: 12px; color: #888888; margin-top:-35px; margin-bottom:15px;'>Sua Loja: {total_sua_loja} • Concorrência: {total_concorrencia} • Total Geral: {len(df_filtrado)}</div>", unsafe_allow_html=True)
