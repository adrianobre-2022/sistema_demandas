                    ...
                    with abas_st[
                        ...
                        if not \
                           ...
                           .empty:
                            ...
                            # 📄 ATENDIDO: BOTÃO DE PDF REATIVADO NATIVAMENTE NO TOPO DE CADA ABA
                            if p_pdf:
                                bytes_pdf = \
                                    gerar_pdf_demandas(
                                        df_f_aba
                            ...
                            for _, \
                                ...
                                .iterrows():
                                    ...
                                    if is_ok_w \
                                       and \
                                       p_wa_v:
                                        # 🎯 COMPONENTE NATIVO: Proteção total anti-corte lateral
                                        u_w = (
                                            f"https://"
                                            f"api.wh"
                                            f"atsapp"
                                        ...
                                        # BOTÃO CINZA FOSCO SIMÉTRICO DA JUSTIFICATIVA CONTRA VÁCUO VISUAL
